...
export default function createContextHook<T extends {}>(theContext: React.Context<T>): () => T;

export default function createContextHook<T extends {}, OutputObject extends {}>(
